...
- [ ] 下一步：在真實 AO run 上跑 Xcode／PR E2E，再補 AO dashboard deep-link。AO live isolated-session、backend-confirmed workspace identity、scene-active reconcile、deterministic restart coverage 與 packaged restart smoke 已完成；乾淨 Mac 與受測者／concierge 驗證已明確延後，不阻塞本輪技術進度。
